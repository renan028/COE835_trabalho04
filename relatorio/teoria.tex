...
%
O diagrama de blocos da implementação de controle 2DOF pode ser visto na \fref{fig:blocks} e sua forma em estrutura 2DOF é mostrada na figura \fref{fig:blocks_2DOF}.
%
\begin{figure}[H]
  \centering
